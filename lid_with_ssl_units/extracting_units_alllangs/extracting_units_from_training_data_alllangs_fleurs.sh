...
#$ -N extract_training_units_alllangs
...
logdir="/home/hltcoe/nbafna/projects/mitigating-accent-bias-in-lid/lid_with_ssl_units/train_logs/fleurs/"
mkdir -p $logdir
logfile="$logdir/extracting_units_from_training_data_fleurs_$lang_$n_clusters.log"
