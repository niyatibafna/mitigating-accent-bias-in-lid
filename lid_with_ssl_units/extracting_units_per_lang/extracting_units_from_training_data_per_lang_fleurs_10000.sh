...
#$ -t 1-107
#$ -tc 4
#$ -j y -o qsub_logs/extracting_units_from_training_data_fleurs_10000/$TASK_ID.out
...
kmeans_dir="/exp/nbafna/projects/mitigating-accent-bias-in-lid/wav2vec2_intermediate_outputs/$dataset_dir/$model_key-$n_clusters/global_kmeans/"
output_dir="/exp/nbafna/projects/mitigating-accent-bias-in-lid/wav2vec2_intermediate_outputs/$dataset_dir/$model_key-$n_clusters/training_units/$lang"
