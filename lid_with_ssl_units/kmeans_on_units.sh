...
#$ -m e
# #$ -t 1-4
#$ -j y -o qsub_logs/kmeans_on_units.out

# Fill out RAM/memory (same thing) request,
# the number of GPUs you want,
# and the hostnames of the machines for special GPU models.
#$ -l h_rt=00:59:00,mem_free=20G
...
# langs=("en" "hi" "es" "sw")
lang="en"
segment_rep_dir="/exp/nbafna/projects/mitigating-accent-bias-in-lid/wav2vec2_intermediate_outputs/timit/$model_key/"
n_clusters=100
echo "Extracting units for $lang"

python lid_with_ssl_units/kmeans_on_units.py \
    --segment_rep_dir $segment_rep_dir \
    --output_dir $segment_rep_dir \
