...
# Load the dataset
dataset = load_lid_dataset("edacc", lang="en")
...
preds_df = df(preds)
print(preds_df)
preds_df.to_csv("/home/hltcoe/nbafna/projects/mitigating-accent-bias-in-lid/prelim_evals/preds/edacc_preds_new.csv")
