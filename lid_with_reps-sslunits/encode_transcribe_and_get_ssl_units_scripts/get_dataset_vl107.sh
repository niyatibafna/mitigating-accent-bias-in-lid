...
#$ -t 1-107
#$ -tc 7
#$ -j y -o qsub_logs/encode_and_transcribe_and_ssl_units_vl107/$TASK_ID.out
...
output_dir="/exp/nbafna/projects/mitigating-accent-bias-in-lid/reps_phoneseqs_duseqs_exps/$dataset_dir/$model_key/${dataset_dir}_data/"
