...
model_key="ecapa-tdnn_wav2vec2-xlsr-53-espeak-cv-ft_wav2vec2-base-layer8-kmeans1000"
...
all_langs=("es" "fr" "de" "it")
lang=${all_langs[$SGE_TASK_ID-1]}


# We use the vl107 dir because the kmeans clustering was done with the vl107 dataset; that is our training dataset.
output_dir="/exp/nbafna/projects/mitigating-accent-bias-in-lid/reps_phoneseqs_duseqs_exps/vl107/$model_key/${dataset_dir}_data/"
...
python /home/hltcoe/nbafna/projects/mitigating-accent-bias-in-lid/lid_with_reps-sslunits/encode_transcribe_and_get_ssl_units.py \
