...
#$ -N reps-sslembed_train_lid
#$ -wd /home/hltcoe/nbafna/projects/mitigating-accent-bias-in-lid/
#$ -m e
#$ -t 1-2
#$ -j y -o qsub_logs/reps-sslembed_train_attentions_$TASK_ID.out
...
output_dir="/exp/nbafna/projects/mitigating-accent-bias-in-lid/reps_phoneseqs_duseqembed_exps/$dataset_dir/$model_key/$lid_model_type-$num_attention_layers/reps-phoneseq-duseqs_lid_model_outputs/"
mkdir -p $output_dir
