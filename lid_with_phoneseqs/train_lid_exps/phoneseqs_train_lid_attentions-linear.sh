...
output_dir="/exp/nbafna/projects/mitigating-accent-bias-in-lid/lid_outputs/$dataset_dir/$model_key/$lid_model_type-$num_attention_layers/phoneseq_lid_model_outputs/"
mkdir -p $output_dir

logdir="/home/hltcoe/nbafna/projects/mitigating-accent-bias-in-lid/lid_with_phoneseqs/train_logs/$model_key/$lid_model_type"
mkdir -p $logdir
logfile="$logdir/train_lid_-attentions-$num_attention_layers-linear.log"
