...
#$ -m e
#$ -t 1-4
#$ -j y -o qsub_logs/dists_and_transcribe_cv_from_hf/$TASK_ID.out

# Fill out RAM/memory (same thing) request,
# the number of GPUs you want,
# and the hostnames of the machines for special GPU models.
#$ -l h_rt=2:00:00,mem_free=20G,gpu=1,hostname=!r8n04&!r9n08&!r7n04&!r8n03&!r5n11
...
output_dir="/exp/nbafna/projects/mitigating-accent-bias-in-lid/dists_and_phoneseqs/$dataset_dir/$model_key/"
mkdir -p $output_dir
...
python /home/hltcoe/nbafna/projects/mitigating-accent-bias-in-lid/lid_with_acoustics-phoneseq/et_dists_and_transcribe_dataset.py \
