...
output_dir="/exp/nbafna/projects/mitigating-accent-bias-in-lid/reps-phoneseq_exps/$dataset_dir/$model_key/$lid_model_type-$num_attention_layers/resp-phoneseq_lid_model_outputs/"
mkdir -p $output_dir
