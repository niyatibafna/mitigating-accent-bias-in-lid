...
output_dir="/exp/nbafna/projects/mitigating-accent-bias-in-lid/transcriptions/fleurs/$model_key/"
mkdir -p $output_dir
echo "Transcribing $lang"

logdir="/home/hltcoe/nbafna/projects/mitigating-accent-bias-in-lid/lid_with_ssl_units/train_logs/transcribe/fleurs/"
mkdir -p $logdir
...
python /home/hltcoe/nbafna/projects/mitigating-accent-bias-in-lid/lid_with_phoneme_transcription/transcribe_data.py \
